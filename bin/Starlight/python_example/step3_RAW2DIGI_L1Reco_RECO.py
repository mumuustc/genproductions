...
# with command line options: step3 --runUnscheduled --conditions auto:phase1_2018_realistic_hi -s RAW2DIGI,L1Reco,RECO --datatier GEN-SIM-RECO -n 2 --era Run2_2018_pp_on_AA --eventcontent AODSIM --filein file:step2.root --fileout file:step3.root --no_exec
