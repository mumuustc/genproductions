...
# with command line options: step2 --conditions auto:phase1_2018_realistic_hi -s DIGI:pdigi_hi,L1,DIGI2RAW,HLT:HIon --datatier GEN-SIM-DIGI-RAW --pileup HiMixNoPU -n 2 --era Run2_2018_pp_on_AA --eventcontent RAWSIM --filein file:step1.root --fileout file:step2.root --no_exec
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:step1_inRAWSIM.root'),
